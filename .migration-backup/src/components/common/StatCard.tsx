...
const colorMap = {
  ...
  slate:   { iconBg: 'bg-slate-500',   iconRing: 'ring-slate-100',   accent: 'from-slate-50',   trend: 'text-slate-600' },
};
...
export default function StatCard({ title, value, icon: Icon, trend, trendUp, color = 'emerald' }: StatCardProps) {
  ...
  return (
    <div className={`bg-white rounded-2xl p-4 border border-slate-200 shadow-sm hover:shadow-md transition-shadow bg-gradient-to-br ${c.accent} to-white`}>
