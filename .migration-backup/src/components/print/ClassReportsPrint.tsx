      ...
      <div id="print-class-reports">
        <div className="print-page">
          <div className="flex justify-end mb-3 print:hidden">
            <button onClick={onClose} className="px-4 py-2 text-sm bg-slate-100 hover:bg-slate-200 rounded-lg text-slate-700 mr-2 transition-colors">Close</button>
              ...
              <div key={pkt.student.id} className="print-card" style={{ border: '2px double #1a3a5c', padding: '8px 10px', background: '#fff' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', marginBottom: '6px' }}>
                  ...
                  <div style={{ border: '1px solid #ccc', borderRadius: '4px', padding: '4px 8px' }}>
                    ...
                    <div className="info-row"><span>Outstanding:</span><span style={{ fontWeight: 700, color: pkt.outstandingFees > 0 ? '#b91c1c' : '#15803d' }}>{fmtMoney(pkt.outstandingFees)}</span></div>
                ...
                <div style={{ border: '1px solid #ccc', borderRadius: '4px', padding: '4px 8px', marginBottom: '4px' }}>
                  ...
                  <div style={{ borderTop: '1px dashed #eee', paddingTop: '3px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px', alignItems: 'flex-end' }}>
                      ...
                      <span style={{ flex: 1, fontSize: '8.5pt', fontStyle: pkt.comments?.principal_comment ? 'normal' : 'italic', color: pkt.comments?.principal_comment ? '#1a1a1a' : '#aaa' }}>
                        {pkt.comments?.principal_comment || '___________________________________'}
                      </span>
