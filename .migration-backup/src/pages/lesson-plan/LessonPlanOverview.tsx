  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Lesson Plan Overview</h1>
          <p className="text-sm text-slate-500 mt-1">View and manage all lesson plans across topics</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                <th className="text-left px-4 py-3 font-medium text-slate-600">Plan Date</th>
            ...
            <tbody>
              {plans.length === 0 ? (
                <tr>
                  <td colSpan={6} className="text-center py-10 text-slate-400">No lesson plans found</td>
                </tr>
              ) : (
                plans.map((plan) => {
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end">
                          <button
                            ...
                            className="flex items-center gap-1.5 p-1.5 text-slate-400 hover:text-emerald-500 hover:bg-emerald-50 rounded-lg transition-colors"
                            title="View plan"
                          >
                            <Eye size={15} />
                          </button>
