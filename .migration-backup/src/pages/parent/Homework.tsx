...
export default function Homework() {
  ...
  const getStatus = (dueDate: string) => {
    if (!dueDate) return { label: 'No Date', color: 'bg-slate-100 text-slate-600' };
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative flex items-center gap-2">
              ...
              <select
                ...
                className="appearance-none border border-slate-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 bg-white pr-9"
              >
          ...
          {assLoading ? (
            ...
            <div className="space-y-3">
              {assignments.map(a => {
                ...
                return (
                  <div key={a.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="text-right shrink-0">
                        ...
                        <p className={`text-sm font-semibold mt-0.5 ${status.label === 'Overdue' ? 'text-red-600' : status.label === 'Due Today' ? 'text-amber-600' : 'text-slate-800'}`}>
