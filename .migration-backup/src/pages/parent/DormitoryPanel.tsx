              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                <div className="bg-gradient-to-r from-slate-700 to-slate-800 px-6 py-5 text-white">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`text-xs font-semibold px-3 py-1.5 rounded-full capitalize ${assignment.status === 'active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-600'}`}>
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
                  ...
                  <div className="space-y-2.5">
                    ...
                    {building.contact_number ? (
                      ...
                      <button className="flex items-center justify-center gap-2 w-full mt-2 py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-600 text-sm font-medium rounded-xl transition-colors border border-slate-200">
                        <Phone className="w-4 h-4" />
                        Contact School
                      </button>
                    )}
                      ...
                      return (
                        <div key={rm.id} className="flex items-center gap-3 p-3 bg-slate-50 rounded-xl">
                          ...
                          <div className="min-w-0">
                            ...
                            {rp?.student_id && <p className="text-xs text-slate-500">ID: {rp.student_id}</p>}
                          </div>
