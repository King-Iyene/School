...
export default function Students() {
  ...
  async function loadStudents() {
    ...
    const cacheKey = `students_v2_p${currentPage}_s${pageSize}_f${filterClass}_y${filterYear}_q${search}_${profile.school_id}`;
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const cacheKey = `students_export_v2_f${filterClass}_y${filterYear}_q${search}_${profile?.school_id}`;
