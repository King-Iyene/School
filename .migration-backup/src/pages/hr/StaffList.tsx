...
const ROLES = ['super_admin', 'admin', 'principal', 'teacher', 'accountant', 'security_officer', 'staff'];
...
export default function StaffList() {
  ...
  const fetchStaff = async () => {
    ...
    let query = supabase
      .from('profiles')
      .select('*')
      .in('role', ['teacher', 'accountant', 'super_admin', 'admin', 'principal', 'security_officer', 'staff'])
      .order('first_name');
