...
export default function Income() {
  ...
  async function fetchLookups() {
    const [{ data: accts }, { data: pms }] = await Promise.all([
      supabase.from('chart_of_accounts').select('id, account_name, account_type').eq('account_type', 'income').order('account_name'),
  ...
  async function handleSave() {
    if (!form.source_name.trim() || !form.account_id || !form.income_date || !form.amount) {
