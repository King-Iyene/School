...
<html><head>
  ...
  <style>
    ...
    h2 { text-align: center; font-size: 18px; text-transform: uppercase; margin: 0; }
    h3 { text-align: center; font-size: 13px; font-weight: normal; margin: 4px 0 12px; color: #444; }
