...
const superAdminNav: NavItem[] = [
  ...
  { label: 'Webhooks',             path: '/system/webhooks',           icon: Webhook,      group: 'System Settings' },
