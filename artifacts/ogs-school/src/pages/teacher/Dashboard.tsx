...
import { Users, BookOpen, ClipboardList, UserCheck, CheckCircle, Clock, GraduationCap, AlertCircle, BarChart2, FileText } from 'lucide-react';
...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    async function load() {
      ...
      // Pending requisitions count (admin/principal/accountant only)
      if (isAdmin || profile.role === 'accountant') {
    ...
    <div className="space-y-6">
      ...
      {profile?.id && profile?.school_id && (
        <RequisitionStatusWidget
          ...
          isApprover={isAdmin || profile.role === 'accountant'}
        />
      )}
