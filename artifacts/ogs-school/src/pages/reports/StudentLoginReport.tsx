...
export default function StudentLoginReport() {
  ...
  function getLoginStatus(updatedAt: string) {
    if (!updatedAt) return { label: 'Never', cls: 'bg-slate-100 text-slate-700' };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-800">Student Login Report</h1>
        <button
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800 mt-1">{activeStudents}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-slate-800 mt-1">{inactiveThirtyPlus}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-500">Never Logged In</p>
              <p className="text-2xl font-bold text-slate-800 mt-1">{neverLoggedIn}</p>
            </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="text-left px-4 py-3 text-slate-600 font-medium">Last Login</th>
                <th className="text-left px-4 py-3 text-slate-600 font-medium">Login Count</th>
                ...
                records.map((record, index) => {
                  ...
                  return (
                    <tr key={record.id} className="border-b border-slate-100 hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 text-slate-600">{getMockLoginCount(record.updated_at)}</td>
