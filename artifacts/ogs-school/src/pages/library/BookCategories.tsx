    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-app-text">Book Categories</h1>
        </div>
        <button
          onClick={openAdd}
      ...
      <div className="bg-app-surface rounded-2xl border border-app-border overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-app-text-muted">No categories found.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead className="bg-app-surface-alt border-b border-app-border">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-app-text-muted">Books</th>
                  <th className="text-left px-4 py-3 font-semibold text-app-text-muted">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-app-border">
                {categories.map((cat) => (
                  <tr key={cat.id} className="hover:bg-app-surface-alt/50">
                    <td className="px-4 py-3 font-medium text-app-text">{cat.name}</td>
                    <td className="px-4 py-3 text-app-text-muted">{cat.description || '-'}</td>
