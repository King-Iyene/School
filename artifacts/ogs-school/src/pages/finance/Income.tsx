  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-app-text">Income</h1>
        <button
          onClick={openCreate}
            ...
            <tbody className="divide-y divide-app-border">
              {records.map((rec) => (
                <tr key={rec.id} className="hover:bg-app-surface-alt transition-colors">
                  ...
                  <td className="px-4 py-3 text-app-text-muted">{rec.income_date}</td>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editId ? 'Edit Income' : 'Add Income'}>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-app-text-muted mb-1">Account (Income)</label>
              <select
                className={INPUT_CLASS}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-app-text-muted mb-1">Income Date</label>
              <input
                type="date"
                className={INPUT_CLASS}
