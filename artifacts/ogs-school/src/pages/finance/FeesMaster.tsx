    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => setShowBuilder(true)} className="bg-app-primary hover:opacity-90 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-colors">
            + Setup Fee Structure
          </button>
          <button onClick={openCreate} className="bg-app-primary hover:opacity-90 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-colors">
            + Add Fees Master
          </button>
        </div>
      </div>
