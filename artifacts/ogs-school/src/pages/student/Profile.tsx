      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-6 pb-6">
          <div className="flex items-end justify-between -mt-10 mb-4">
            <div className="w-20 h-20 rounded-2xl bg-white border-4 border-white shadow-md flex items-center justify-center text-2xl font-bold text-emerald-600">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-800">{studentData?.first_name} {studentData?.last_name}</h2>
            <p className="text-sm text-slate-500 mt-0.5">{studentData?.email}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-50 rounded-xl p-3">
                <p className="text-xs text-slate-500 mb-0.5">Admission No.</p>
                <p className="text-sm font-semibold text-slate-800">{studentData?.admission_number || '—'}</p>
              </div>
              <div className="bg-slate-50 rounded-xl p-3">
                <p className="text-xs text-slate-500 mb-0.5">Roll Number</p>
                <p className="text-sm font-semibold text-slate-800">{studentData?.roll_number || enrollment?.roll_number || '—'}</p>
              </div>
              <div className="bg-slate-50 rounded-xl p-3">
              ...
              <div className="bg-slate-50 rounded-xl p-3">
                <p className="text-xs text-slate-500 mb-0.5">Section</p>
                <p className="text-sm font-semibold text-slate-800">{cls?.section || '—'}</p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-800">{studentData?.date_of_birth ? new Date(studentData.date_of_birth).toLocaleDateString() : '—'}</p>
                </div>
              </div>
              <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-800 capitalize">{studentData?.gender || '—'}</p>
                </div>
              </div>
              <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
                <Droplet className="w-4 h-4 text-slate-400 mt-0.5 shrink-0" />
                <div>
                  <p className="text-xs text-slate-500 mb-0.5">Blood Group</p>
                  <p className="text-sm font-semibold text-slate-800">{studentData?.blood_group || '—'}</p>
                </div>
              </div>
              <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-800">{studentData?.phone || '—'}</p>
                </div>
              </div>
            </div>
            <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-800">{studentData?.email || '—'}</p>
              </div>
            </div>
            <div className="bg-slate-50 rounded-xl p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-slate-800">{studentData?.address || '—'}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-5">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="space-y-3">
              <div className="bg-slate-50 rounded-xl p-3">
                <p className="text-xs text-slate-500 mb-0.5">Guardian Name</p>
                <p className="text-sm font-semibold text-slate-800">{studentData?.guardian_name || '—'}</p>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-50 rounded-xl p-3">
                  <p className="text-xs text-slate-500 mb-0.5">Relation</p>
                  <p className="text-sm font-semibold text-slate-800 capitalize">{studentData?.guardian_relation || '—'}</p>
                </div>
                <div className="bg-slate-50 rounded-xl p-3">
                  <p className="text-xs text-slate-500 mb-0.5">Phone</p>
                  <p className="text-sm font-semibold text-slate-800">{studentData?.guardian_phone || '—'}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
            ...
            <div className="flex gap-3 p-5 border-t border-slate-100">
              <button onClick={() => setEditOpen(false)} className="flex-1 py-2.5 text-sm font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors">
                Cancel
              </button>
              <button
                onClick={handleSave}
