  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-slate-500 text-sm">Monitor your children's school attendance</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: 'Attendance Rate', value: `${rate}%`, color: 'text-slate-800' },
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-slate-100">
            {loading ? (
              ...
              <tr><td colSpan={4} className="text-center py-8 text-slate-400">No records for this month</td></tr>
            ) : attendance.map(a => (
