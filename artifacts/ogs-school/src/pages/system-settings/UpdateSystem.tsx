    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-slate-800">System Update</h1>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-slate-800 mt-0.5">v2.1.0</p>
      ...
      <div>
        <h2 className="text-base font-semibold text-slate-700 mb-4">System Status</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Database</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Server</p>
            </div>
            <p className="text-lg font-bold text-slate-800">Running</p>
            <div className="flex items-center gap-1.5 mt-1.5">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-5">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Last Backup</p>
            </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        <h2 className="text-base font-semibold text-slate-700 mb-4">Version History</h2>
          ...
          {[
            ...
            <div key={v.version} className="flex items-start gap-4">
              <div className="flex flex-col items-center">
                <div className={`w-3 h-3 rounded-full border-2 mt-0.5 ${idx === 0 ? 'border-emerald-500 bg-emerald-500' : 'border-slate-300 bg-white'}`}></div>
